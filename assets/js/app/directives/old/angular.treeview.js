    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        var template =
          ...
          '<span data-ng-class="{\'selected\':node.selected}" data-ng-click="' + treeId + '.selectNodeLabel(node)">{{node.' + nodeLabel + '}}</span>' +
          '<md-icon ng-show="node.hasRead || node.passed" md-svg-icon="images/icons/check.svg"></md-icon>' +
